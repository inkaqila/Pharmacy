...
//    DATABASE TOOLS
    ...
    private String[] addMedicineListT = {"Antibiotik", "Antiinflamasi", "Analgetik", "Antipiretik", "Vitamin"};
    ...
    public void defaultNav(){
        dashboard_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #11009E, #C4B0FF);");
    }
    ...
    public void switchForm(ActionEvent event){
        ...
        if(event.getSource() == dashboard_btn){
            ...
            addMed_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #11009E, #C4B0FF);");
            ...
            pruchase_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #11009E, #C4B0FF);");
            dashboard_btn.setStyle("-fx-background-color:transparent");
            addMed_btn.setStyle("-fx-background-color:transparent");
